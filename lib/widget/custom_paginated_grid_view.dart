...
class CustomPaginatedGridView<T> extends StatefulWidget {
  ...
  const CustomPaginatedGridView({
    ...
    this.reverse = false,
    this.shrinkWrap = false, required this.gridDelegate,
  });

  @override
  State<CustomPaginatedGridView<T>> createState() =>
      _CustomPaginatedGridViewState<T>();
}

class _CustomPaginatedGridViewState<T>
    extends State<CustomPaginatedGridView<T>> {
