...
import 'request_guide_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          // UPDATED: Changed Icon to Asset Image
                          prefixIcon: Padding(
                            padding: const EdgeInsets.all(12.0),
                            child: Image.asset(
                              'assets/icons/search_outline.png', // CHANGE IF FILENAME DIFFERS
                              width: 20,
                              height: 20,
                    ...
                    if (userDataNotifier.value != null) ...[
                      ...
                      // UPDATED: Using Asset Path for Star
                      _buildSectionHeader(
                        title: 'Featured Guides',
                        assetPath:
                            'assets/icons/star_outline.png', // CHANGE IF FILENAME DIFFERS
                        iconColor: kAccentOrange,
                      ),
                      const SizedBox(height: 16),

                      // --- FEATURED GUIDES LIST ---
                      if (dashBoardProvider.guide.isNotEmpty)
                        SizedBox(
                          height: 220,
                          child: ListView.builder(
                            scrollDirection: Axis.horizontal,
                            clipBehavior: Clip.none,
                            itemCount: dashBoardProvider.guide.length,
                            itemBuilder: (context, index) {
                              Guide guide = dashBoardProvider.guide[index];
                              String imageUrl =
                                  guide.guidePrefrence?.profileImage ?? "";
                              String universityName = _getUniversityNames(
                                guide.guidePrefrence?.university ?? "",
                    ...
                    // --- TRENDING MAJORS ---
                    // UPDATED: Using Asset Path for Trending
                    _buildSectionHeader(
                      title: 'Trending Majors',
                      assetPath:
                          'assets/icons/trending.png', // CHANGE IF FILENAME DIFFERS
                      iconColor: kAccentOrange,
                    ),
                    const SizedBox(height: 16),
                      ...
                      Wrap(
                        ...
                        children: dashBoardProvider.category.map((category) {
                          return GestureDetector(
                            onTap: () {
                              SearchGuideProvider searchGuideProvider =
                                  Provider.of<SearchGuideProvider>(context,
                                      listen: false);
                              searchGuideProvider.resetAllValues();
                              searchGuideProvider.searchCategoryId =
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      const SearchScreen(searchValue: ""),
                                ),
                              );
                            },
                            child: Container(
                    ...
                    // --- CANT FIND GUIDE SECTION ---
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const RequestGuideScreen(),
                          ),
                        );
                      },
                      child: CustomPaint(
                    ...
                    // --- TOP GUIDES SECTION (VERTICAL LIST) ---
                    _buildSectionHeader(
                      title: 'Top Guides',
  ...
  // UPDATED HELPER FUNCTION TO ACCEPT ASSET PATHS
